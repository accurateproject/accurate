...
var (
	...
	PrimaryCdrFields = []string{UniqueID, CDRSOURCE, CDRHOST, ACCID, TOR, REQTYPE, DIRECTION, TENANT, CATEGORY, ACCOUNT, SUBJECT, DESTINATION, SETUP_TIME, PDD, ANSWER_TIME, USAGE,
...
const (
	...
	DESTINATION_RATES_JSON       = "DestinationRates.json"
	RATING_PLANS_JSON            = "RatingPlans.json"
	RATING_PROFILES_JSON         = "RatingProfiles.json"
	SHARED_GROUPS_JSON           = "SharedGroups.json"
	LCRS_JSON                    = "LcrRules.json"
	ACTIONS_JSON                 = "Actions.json"
	ACTION_PLANS_JSON            = "ActionPlans.json"
	ACTION_TRIGGERS_JSON         = "ActionTriggers.json"
	ACCOUNT_ACTIONS_JSON         = "AccountActions.json"
	DERIVED_CHARGERS_JSON        = "DerivedChargers.json"
	CDR_STATS_JSON               = "CdrStats.json"
	USERS_JSON                   = "Users.json"
	ALIASES_JSON                 = "Aliases.json"
	RESOURCE_LIMITS_JSON         = "ResourceLimits.json"
	ROUNDING_UP                  = "*up"
	...
	DestExact                    = "*dest_exact"
	DestMatching                 = "*dest_matching"
)
