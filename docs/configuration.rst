...
The behaviour of **AccuRate** can be externally influenced by following means:
...
- **Tariff Plans**: set of files used to import various data used in AccuRate subsystems (eg: Rating, Accounting, LCR, DerivedCharging, etc).
